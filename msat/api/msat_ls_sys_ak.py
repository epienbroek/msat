...
#
#   msat_ls_sys_ak.py is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_ls_sys_ak.py is distributed in the hope
...
usage = '''list systems activation keys'''

description = '''This script lists the activation keys per system.'''
...
for i in systems:
  ...
  try:
    activation_keys = client.system.listActivationKeys(
      key,
      i['id']
    )
  except xmlrpclib.Fault, e:
    print >> sys.stderr, str(e)
  for j in activation_keys:
    print '  ' + j
