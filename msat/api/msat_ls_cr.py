...
#
#   msat_ls_cr.py is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_ls_cr.py is distributed in the hope
...
usage = '''list cryptographic keys'''

description = '''This script lists the cryptographic keys on the specified Satellite server.'''
...
try:
  keys = client.kickstart.keys.listAllKeys(
    key,
  )
