...
#
#   msat_rm_kp.py is free software; you can redistribute it
#   and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_rm_kp.py is distributed in the hope that it will be
...
usage = '''delete kickstart profile'''

description = '''This script deletes the specified kickstart profile.'''
...
try:
  rc = client.kickstart.deleteProfile(
    key,
