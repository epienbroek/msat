...
# 
#   msat_rm_ak.py is free software; you can redistribute it
#   and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_rm_ak.py is distributed in the hope that it will be
...
usage = '''delete activation key'''

description = '''This script deletes the specified activation key.'''
...
# create activationkey profile
try:
  rc = client.activationkey.delete(
    key,
