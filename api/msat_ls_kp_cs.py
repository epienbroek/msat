...
# 
#   msat_ls_kp_cs.py is free software; you can redistribute
#   it and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_ls_kp_cs.py is distributed in the hope that it will
...
def scan_for_snippet(snippets, contents, level):
  for line in contents.split('\n'):
    ...
    if m:
      print '%s%s' % ('  ' * level, m.group(1))
      scan_for_snippet(snippets, snippets[m.group(1)], level + 1)

usage = '''list cobbler snippets of kickstart profile'''

description = '''This script lists the Cobbler snippets of the specified kickstart profile on the specified Satellite server.'''
