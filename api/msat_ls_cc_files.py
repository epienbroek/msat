...
# 
#   msat_ls_cc_files.py is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_ls_cc_files.py is distributed in the hope that it
...
usage = '''list the latest revision of the config files in the specified config channel'''

description = '''This script lists the latest revision of the config files in the specified config channel. If the config channel does not exist, an error will be given and a dump of the used parameters.'''
