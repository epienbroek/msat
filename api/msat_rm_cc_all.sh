...
#
#   msat_rm_cc_all.sh is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_rm_cc_all.sh is distributed in the hope
...
xml_help() {
  cat << EOF__EOF
<refnamediv>
<refname>msat_rm_cc_all.sh</refname>
<refpurpose>removes all config channels in org</refpurpose>
</refnamediv>
<refsynopsisdiv>
<cmdsynopsis>
  <command>msat_rm_cc_all.sh</command>
...
<para>This script removes all the config channels in the current Satellite organization.</para>
</refsect1>
<refsect1>
<title>OPTIONS</title>
<para>
...
msat_ls_cc.py | while read line
do
  msat_rm_cc.py -l "$line"
done
