...
#
#   msat_ls_cc.py is free software; you can redistribute it
#   and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_ls_cc.py is distributed in the hope that it will be
...
usage = '''list the config channels'''

description = '''This script lists the config channels available on the Satellite server.'''
