...
# 
#   msat_ls_sys_up.py is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_ls_sys_up.py is distributed in the hope
...
usage = '''list active systems'''

description = '''This script lists the systems marked active on the Satellite server.'''
...
try:
  active_systems = client.system.listActiveSystems(
    key,
  )
except xmlrpclib.Fault, e:
  print >> sys.stderr, str(e)

for i in active_systems:
  print 'id: ' + str(i['id'])
  print 'name: ' + i['name']
  print 'date: ' + str(i['last_checkin'])
  print
