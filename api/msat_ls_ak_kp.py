...
#
#   msat_ls_ak_kp.py is free software; you can redistribute
#   it and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_ls_ak_kp.py is distributed in the hope that it will
...
# * other (epilog)
usage = '''list kickstart profiles referencing specified activation key'''

description = '''This script lists the kickstart profiles that reference the specified activation key.'''
...
try:
  kickstarts = client.kickstart.listKickstarts(
    key,
  )
...
for k in kickstarts:
  try:
    ...
    print >> sys.stderr, str(e)
    print >> sys.stderr, k['label']
    sys.exit(1)

  for a in activation_keys:
    if a.get('key') == options.activationkey_label:
      print k['label']
      break
