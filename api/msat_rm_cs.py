...
#   msat_rm_cs.py
# DESCRIPTION
#   Remove a cobbler snipped via the command line. See the
...
#
#   msat_rm_cs.py is free software; you can redistribute it
#   and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_rm_cs.py is distributed in the hope that it will be
...
usage = '''removes the specified cobbler snippet'''

description = '''This script removes the specified cobbler snipped to the Satellite. If the cobbler snippet does not exist, an exception will be thrown and the parameters dumped.'''
...
try:
  rc = client.kickstart.snippet.delete(
    key,
    options.snippet_name,
  )
