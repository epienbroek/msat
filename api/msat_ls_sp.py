...
#   msat_ls_sl.py
# DESCRIPTION
#   Convenience script to obtain the satellite login (sl)
...
# 
#   msat_ls_sl.py is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_ls_sl.py is distributed in the hope
...
usage = '''obtain satellite login from sat.conf'''

description = '''This script reads the satellite login from the sat.conf configuration file.'''
...
if options.satellite_password:
  print options.satellite_password
else:
  print >> sys.stderr, "ERROR: unable to obtain satellite password from config file. Check ~/.sat.conf"
  sys.exit(1)
