...
# 
#   msat_ls_ak_sys.py is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_ls_ak_sys.py is distributed in the hope
...
usage = '''list activation key activated systems'''

description = '''This script lists the activated systems based on the specified activation key.'''
...
try:
  activated_systems = client.activationkey.listActivatedSystems(
    key,
...
for i in activated_systems:
  print 'id: ' + str(i['id']) + ', hostname: ' + i['hostname']
