...
#
#   msat_ls_kp_co.py is free software; you can
#   redistribute it and/or modify it under the terms of the
#   GNU General Public License as published by the Free
#   Software Foundation; either version 3 of the License, or
#   (at your option) any later version.
#
#   msat_ls_kp_co.py is distributed in the hope
...
usage = '''list custom options of kickstart profile'''

description = '''This script lists the cutsom options of the specified kickstart profile on the specified Satellite server.'''
...
try:
  koptions = client.kickstart.profile.getCustomOptions(
    key,
