...
# 
#   msat_ls_sc_org.py is free software; you can redistribute it
#   and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_ls_sc_org.py is distributed in the hope that it will be
...
usage = '''list software channel trusted orgs'''

description = '''This script lists the trusted orgs for the specified software channel.'''
...
for i in orgs:
  print "%5d: %-20.20s access? %s" % (i['org_id'], i['org_name'], i['access_enabled'])
