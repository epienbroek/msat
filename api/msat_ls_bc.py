...
# 
#   msat_ls_bc.py is free software; you can redistribute it
#   and/or modify it under the terms of the GNU General
#   Public License as published by the Free Software
#   Foundation; either version 3 of the License, or (at your
#   option) any later version.
#
#   msat_ls_bc.py is distributed in the hope that it will be
...
usage = '''list base channels'''

description = '''This script lists the available base channels on the Satellite server.'''
...
try:
  channels = client.channel.listSoftwareChannels(
    key,
  )
